...
##Process Soil-Sediment Thickness layer
```{r eval=FALSE}
### Sed Thickness###
...
##Load GEE Monthly RS Mean and STD rasters
```{r eval=FALSE}
...
##Load in Hyper-temporal imagery
```{r eval=FALSE}
...
##Align Raster Covariate Extents to allow stacking
```{r eval=FALSE}
